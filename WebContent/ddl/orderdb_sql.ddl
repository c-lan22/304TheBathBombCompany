...
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Minecraft Creeper Bath Bombs',2,'48 - 6 oz jars',22.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('F-Bomb Bath Bomb',2,'36 boxes',21.35);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('AmongUs Imposters Bath Bombs',2,'12 - 8 oz jars',25.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Taking Care of Buisiness Bath Bomb Set',4,'12 - 1 lb pkgs.',30.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Pokemon Pokeball Bath Bomb Set',2,'12 - 12 oz jars',40.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Premium Scented Chill Pill Bath Bomb',5,'18 - 500 g pkgs.',97.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Baby Yoda Premium Bath Bomb',6,'12 - 200 ml jars',31.00);
